...
def main(args):
    ...
    p=PostProcessor(args.outputfile,files,cut=None, branchsel=None, postfix="", outputbranchsel="keep_and_drop.txt", modules=mods,provenance=False,maxEvents=args.maxEvents)
    p.run()
